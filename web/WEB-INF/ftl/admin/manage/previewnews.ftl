    ...
    <div class="row">
        ...
        <#else>
            <blockquote>
                ...
                <small>转载请注明：文章转载自：<strong>沃尔沃车友俱乐部</strong> [<a href="http://www.volvoownerclub.com">http://www.volvoownerclub.com</a>]</small>
                <small>本文标题：${news.get("title")}</small>
                <small>本文地址：<a href="http://www.volvoownerclub.com/news/${news.get("id")}">http://www.volvoownerclub.com/news/${news.get("id")}</a></small>
            </blockquote>
        </#if>
        </div>
