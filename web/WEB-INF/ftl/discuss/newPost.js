$(function () {
    ...
    $("#releaseForm button").click(function (e) {
        e.preventDefault();
        $this = $(this);
        $("#releaseForm button").removeClass("btn-info");
        ...
        if ($("#releaseForm").validation()) {
            ...
            if (html == "") {
                ...
                param.push({
                    ...
                    name: "c",
                    value: $("#releaseForm button.btn-info").attr("rel")
                })
                $this.text("保存中，请稍候。。。");
                $this.attr("disabled", true);
                $.ajax({
                    url: "${_BASE_PATH}/discuss/addPost",
                    data: param,
                    success: function (result) {

                        window.location.href = "${_BASE_PATH}/discuss?c=" + $("#releaseForm button.btn-info").attr("rel");
                    }
                })
            }
