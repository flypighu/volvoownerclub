    ...
    <div class="QuestionList">
        ...
        <div class="tabbable">
            ...
            <div class="tab-content">
                ...
                <@_pagination pageNumber=rlist.getPageNumber() totalPage=rlist.getTotalPage() url=_BASE_PATH + "/discuss?c=2"/>
...
<div class="span4">
    <ul class="breadcrumb" style="text-align: center">
        <li><p>有很好的改装经验？ </p>
            ...
            <p><a class="btn btn-primary" href="/discuss/post?c=2">我要分享</a></p></li>
    </ul>
    <!-- 热门标签 begin-->
    <!--
    <div class="hottag">
