    ...
    <div class="QuestionList">
        ...
        <div class="tabbable">
            ...
            <div class="tab-content">
                ...
                <@_pagination pageNumber=rlist.getPageNumber() totalPage=rlist.getTotalPage() url=_BASE_PATH + "/discuss?c=3"/>
                            ...
                            <div class="qbody">
                                ...
                                ${x.name} 发布于 ${x.rtime}
                                    <#if x.last_reply?exists>
                                        ，最后回答${x.last_reply}：<a
                                            href="/question/question/${rel}_${x.id}">${x.lastman}»</a>
                                    </#if>
...
<div class="span4">
    <ul class="breadcrumb" style="text-align: center">
        <li><p>自驾游分享</p>
            ...
            <p><a class="btn btn-primary" href="/discuss/post?c=3">我要发帖</a></p></li>
    </ul>
    <!-- 热门标签 begin-->
    <!--
    <div class="hottag">
