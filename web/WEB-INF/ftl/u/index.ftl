        ...
        <#include "/WEB-INF/ftl/u/index_center_top.ftl"/>
            ...
            <div id="Logs" class="MMod">
                <ul class="nav nav-tabs">
                    <li class="active"><a href="/u/${u.url}">动弹</a></li>
            ...
            <#--</div>-->
                <div class="tabbable">
                    <div class="tab-content">
                                        ...
                                        <table class="ostable">
                                            ...
                                            <tr>
                                                ...
                                                <td class="TweetContent">
                                                    ...
                                                    <div class="bottom">
                                                        <div class="opts">
                                                            <a class="TweetReplyLnk" href="/dongtan/${x.id}">评论<span>(${x.comments})</span></a>
                                                        </div>
                        ...
                        <@_pagination pageNumber=rlist.getPageNumber() totalPage=rlist.getTotalPage() url="/u/${u.url}"/>
                        </div>
                    </div>
                </div>
            </div>
