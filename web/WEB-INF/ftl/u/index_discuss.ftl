        ...
        <#include "/WEB-INF/ftl/u/index_center_top.ftl"/>
            ...
            <div id="Logs" class="MMod">
                <ul class="nav nav-tabs">
                    ...
                    <li class="active"><a href="/u/${u.url}?t=discuss">讨论区</a></li>
                    <li><a href="/u/${u.url}?t=news">新闻</a></li>
                </ul>
            <#--<div class="ref">-->
            ...
            <#--</div>-->
                <div class="tabbable">
                    <div class="tab-content">
                                    ...
                                    <table class="ostable">
                                        ...
                                        <tr>
                                            ...
                                            <td class="TweetContent">
                                                ...
                                                <div class="bottom">
                                                    <div class="opts">
                                                        <a class="TweetReplyLnk" href="/discuss/${x.disid}_${x.id}">评论<span>(${x.reply})</span></a>
                                                    </div>
                                                    <div class="time">${_checkTimeQian(x.rtime)} </div>
                                                </div>
                                            </td>
                                        </tr>
                                        </tbody>
                        ...
                        <@_pagination pageNumber=rlist.getPageNumber() totalPage=rlist.getTotalPage() url="/u/${u.url}?t=discuss"/>
                        </div>
                    </div>
                </div>
            </div>
